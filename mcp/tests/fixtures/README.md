...
| `tools-list.json` | Complete canonical `mirror` catalog. | `fd4e96751aa8032567834799a06356a1bb4a8d8c8e430f4d567ce62f80fc8ff2` | `RUSTWRIGHT_UPDATE_TOOL_CATALOG=1 cargo test --manifest-path mcp/Cargo.toml --locked catalog_matches_archived_bytes` |
