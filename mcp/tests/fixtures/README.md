...
| `tools-list.json` | Complete canonical `mirror` catalog. | `04a8f9ce0c6f9e02905cd19c896dd623dfb38a0ad2fdf10758b6a1388307fc90` | `RUSTWRIGHT_UPDATE_TOOL_CATALOG=1 cargo test --manifest-path mcp/Cargo.toml --locked catalog_matches_archived_bytes` |
