...
| `tools-list.json` | Complete canonical `mirror` catalog. | `207626aaf96b21f2849547f91abe4c4c64fb4fc2fbb798b8a42a4b639504d444` | `RUSTWRIGHT_UPDATE_TOOL_CATALOG=1 cargo test --manifest-path mcp/Cargo.toml --locked catalog_matches_archived_bytes` |
